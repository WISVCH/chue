...
public interface HueFacade {
     ...
     * Meijer</a>
     */
    void strobe(int millis, String... lightIdentifiers) throws NotExecutedException;
     ...
     */
    void updateLightState(String id, HueLightState lightState) throws NotExecutedException;
}
